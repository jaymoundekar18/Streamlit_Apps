...
# from app.services.api_client import APIClient  # your API client
...
#         # Fetch user details from API (or session)
#         user = APIClient.get_user(st.session_state.current_user_id)
...
#         name = st.text_input(
#             "Full Name",
#             value=st.session_state.user_details.get('fullname'),
...
#             "Username",
#             value=st.session_state.user_details.get('username'),
#             disabled=not st.session_state.edit_profile,
...
#         email = st.text_input(
#             "Email",
#             value=st.session_state.user_details.get('email'),
#             disabled=not st.session_state.edit_profile,
...
#     # Fetch user details once and store in session_state
#     if "account_name" not in st.session_state:
#         user = APIClient.get_user(st.session_state.current_user_id)
#         st.session_state.account_name = user.get("fullname", "")
#         st.session_state.account_username = user.get("username", "")
...
#         if edit_clicked:
#             st.session_state.edit_profile = True
#             st.session_state.page = "Account"  # ✅ persist page
