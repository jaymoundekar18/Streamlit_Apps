...
st.title(APP_TITLE)
image = Image.open("/mount/src/streamlit_apps/VirtualBookLibrary/app/assets/imgs/book.png") #/workspaces/Streamlit_Apps/VirtualBookLibrary/app/assets/imgs/book.png
